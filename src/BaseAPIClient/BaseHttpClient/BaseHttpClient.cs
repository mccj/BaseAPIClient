...
namespace SDK.BaseAPI
{
    public class BaseHttpClient : HttpClient
    {
        ...
        { }
        public BaseHttpClient(HttpClientHandler handler, Uri url = null, MediaType mediaType = MediaType.Json, string[] supportedMediaTypes = null, bool ifNullRemove = true) : base(handler)
        {
